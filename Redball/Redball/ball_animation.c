...
int main(void)
{
   ...
   //Box A: Moving box (level 1)
    ...
    int bounceCount = 0; 
    bool growBall = false; 
    float growSpeed = 3.8f; // Growth rate
...
case BALL_ANIMATION: {
    ...
    DrawRectangle(logoPositionX, logoPositionY, 16, 16, Fade(BLACK, alpha+10)); 
        ...
        case BALL_ANIMATION:
            ...
            // Top animasyonu çizim işlemleri
            ClearBackground(WHITE); // Ekranı temizle
            DrawCircleV(ballPosition, ballRadius * scale, BLACK); // Topu çiz
            break;
